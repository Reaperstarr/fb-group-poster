/**
 * Irishka Fleet — inline SVG icon set (Feather-style, 24×24)
 */
(function () {
  'use strict';
  ...
  const PATHS = {
    ...
    sparkles: '<path d="M12 3l1.2 3.6L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2L12 3z"/><path d="M5 16l.6 1.8L7.4 19l-1.8.6L5 21.4l-.6-1.8L2.6 19l1.8-.6L5 16z"/><path d="M19 14l.8 2.4L22 17l-2.2.7L19 20l-.8-2.3L16 17l2.2-.6L19 14z"/>',
    ...
    broom: '<path d="M12 3v4"/><path d="M6 7h12"/><path d="M5 11l-2 9h18l-2-9"/><path d="M8 11V9a4 4 0 0 1 8 0v2"/>',
    ...
    'circle-warn': '<circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>',
  };
  ...
  function icon(name, className) {
    ...
    return `<span class="fi${extra}" aria-hidden="true">${svg(name)}</span>`;
  }

  window.FleetIcons = { icon, svg, names: Object.keys(PATHS) };
})();
